...
@implementation XMGoViewController
...
//    searchTypeSegCtl.segmentedControlStyle = UISegmentedControlStyleBar;
    searchTypeSegCtl.frame = CGRectMake(20, kDeviceHeight-40, kDeviceWidth-40, 38);
    [self.view addSubview:searchTypeSegCtl];
...
//    self.nextItem = nextItem;
    ...
    self.toolbarItems = [NSArray arrayWithObjects:flexbleItem, searchTypeItem, flexbleItem, flexbleItem, flexbleItem, nil];
}
