...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.scrollView.bottom-20, kDeviceWidth, 20)];
...
- (void)configContentViews
{
    ...
    for (UIView *contentView in self.contentViews) {
        ...
        rightRect.origin = CGPointMake(kDeviceWidth * (counter ++), 0);
