...
+ (void)setView:(UIView*)view attr:(NSLayoutAttribute)attr sAttr:(NSLayoutAttribute)sAttr constant:(CGFloat)constant
{
    [[view superview] addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:attr relatedBy:NSLayoutRelationEqual toItem:[view superview] attribute:sAttr multiplier:1.0 constant:constant]];
}
...
- (void) makeInsetShadow
{
    ...
    [self createShadowViewWithRadius:1 Color:color Directions:shadowDirections];
}
