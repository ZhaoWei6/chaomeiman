...
#define kTextFontColor34  XMColor(34,34,34)
#define kTtextFontColor68 XMColor(68,68,68)
...
//  7.定义一个枚举，用于判断用户选择的是“修iPhone”、“修小米”、“修锁”、“手机回收”中的哪一个
typedef enum kCategory {
    kiPhone  = 0,
    kXiaoMi  = 1,
    kKey     = 2,
    kRecover = 3
}kCategory;
kCategory categoryStyle;
