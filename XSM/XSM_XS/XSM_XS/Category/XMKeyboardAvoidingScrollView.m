//
//  XMKeyboardAvoidingScrollView.m
//  XiuShenMa
//
...
@interface XMKeyboardAvoidingScrollView ()<UITextFieldDelegate, UITextViewDelegate> {
...
@implementation XMKeyboardAvoidingScrollView
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    //        {
    //            NSLog(@"%@",((UITextField *)childView).text);
    //        }
    //    }
